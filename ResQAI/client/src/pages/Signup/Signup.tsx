    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col justify-center items-center p-4">
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="glass-panel border border-slate-200/50 dark:border-slate-800/40 p-6 md:p-8 rounded-3xl space-y-5 shadow-xl">
          <h2 className="text-xl font-extrabold text-slate-850 dark:text-white">Create Account</h2>
          ...
          <div className="text-center pt-2">
            ...
            <Link to="/login" className="text-xs text-medical-500 font-bold hover:underline">
              Log In
            </Link>
          </div>
        </div>
